import{i as d,c as g,K as b,u as q,s as y,l as Q}from"./assets/footer-8f9eb7d1.js";import{a as S,P as V,N as X,l as ee}from"./assets/vendor-4b895a38.js";const te="https://food-boutique.b.goit.study/api/",oe="products/categories",se="products",ae="products/",re="products/popular",ne="products/discount",ce="subscription",ie="orders",f=S.create({baseURL:te});class le{static async getCategories(){return(await f.get(oe)).data}static async getProducts({keyword:e,category:s,page:o,limit:a,sortBy:r}={}){return(await f.get(se,{params:{keyword:e,category:s,page:o,limit:a,[r==null?void 0:r.key]:r==null?void 0:r.value}})).data}static async getProduct(e){return(await f.get(ae+e)).data}static async getPopularProducts(e=5){return(await f.get(re,{params:{limit:e}})).data}static async getDiscountedProducts(){return(await f.get(ne)).data}static async subscribe(e){return(await f.post(ce,{email:e})).data}static async placeOrder(e){const{email:s,products:o}=e;return(await f.post(ie,{email:s,products:o.map(({productId:r,amount:c})=>({productId:r,amount:c}))})).data}}const h=document.querySelector(".modal-background"),_=document.querySelector(".modal");async function de(t){try{h.classList.remove("is-hidden"),document.body.classList.add("is-modal-open"),_.innerHTML=`
      ...
      <svg class="modal-icon-shop" width="18" height="18">
        <use href="${d}#icon-shopping-cart"></use>
    ...
    </div>`}function pe(t){g.push(t),localStorage.setItem(b,JSON.stringify(g)),q(),document.querySelector(".modal-btn").style.display="none",document.querySelector(".modal-btn-remove").style.display="block"}function ge(t){for(let e=0;e<g.length;e++)g[e]._id===t._id&&(g.splice(e,1),localStorage.setItem(b,JSON.stringify(g)),q(),document.querySelector(".modal-btn").style.display="block",document.querySelector(".modal-btn-remove").style.display="none")}function U({target:t}){t===h&&$()}function $(){h.classList.add("is-hidden"),document.body.classList.remove("is-modal-open"),document.querySelector(".modal-close-btn").removeEventListener("click",$),h.removeEventListener("click",U),document.removeEventListener("keydown",z)}function z({key:t}){t==="Escape"&&$()}const W="filter",D={paginationDop:document.querySelector(".paginationDop"),pagination:document.querySelector(".tui-pagination"),list:document.querySelector(".product-list"),search:document.querySelector("#search")},me=document.getElementById("pagination");let v,T=3,F;function ye(){const t=localStorage.getItem(W);if(t)try{const e=JSON.parse(t);F=e.page,v=e.limit}catch(e){console.error("Error updating localStorage:",e)}}function fe(t){let e={totalItems:t,itemsPerPage:v,visiblePages:T,page:F,centerAlign:!0,firstItemClassName:"tui-first-child",lastItemClassName:"tui-last-child",template:{page:'<a href="#" class="tui-page-btn">{{page}}</a>',currentPage:'<strong class="tui-page-btn tui-is-selected">{{page}}</strong>',moveButton:'<a href="#" class="tui-page-btn tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></a>',disabledMoveButton:'<span class="tui-page-btn tui-is-disabled tui-{{type}}"><span class="tui-ico-{{type}}">{{type}}</span></span>',moreButton:'<a href="#" class="tui-page-btn tui-{{type}}-is-ellip"><span class="tui-ico-ellip">...</span></a>'}};new V(me,e).on("beforeMove",be)}function be(t){const e=localStorage.getItem(W);if(e)try{const s=JSON.parse(e);s.page=Number(`${t.page}`),localStorage.setItem("filter",JSON.stringify(s))}catch(s){console.error("Error updating localStorage:",s)}D.list.innerHTML="",u()}async function A(t){t<=Number(v)?D.pagination.classList.replace("tui-pagination","paginationDop"):(ye(),D.pagination.classList.replace("paginationDop","tui-pagination")),v===9||v===8?T=4:T=2}const C={list:document.querySelector(".product-list")};let E=[],k;async function u(){document.getElementById("overlay").style.display="flex",we();const t=await $e();k=t.data.totalPages*t.data.perPage,A(k),fe(k);try{let e;t&&(e=t),E=e.data.results,ve(E)}catch(e){console.error(e)}finally{document.getElementById("overlay").style.display="none"}}function ve(t){const e=localStorage.getItem(b),s=`<div class="error-load">
                ...
                <p class="not-found-message">Try adjusting your search parameters or browse our range by other criteria
                    ...
                    product for
                    you.</p>
            </div>`,o=t.map(({img:a,name:r,popularity:c,category:l,price:m,size:i,_id:n,is10PercentOff:L})=>{const w=l.replace(/_/g," "),P=e?JSON.parse(e).some(I=>I._id===n):!1,K=L||(e?t.some(I=>I.is10PercentOff===!0):!1)?"icon-discount-pl":"visually-hidden",G=P?`${d}#icon-cart`:`${d}#icon-shopping-cart`;return`<li class="item-pl" data-id="${n}">
            ...
            </li>`}).join("");C.list.innerHTML=o||s}window.addEventListener("load",u);C.list.addEventListener("click",N);function N(t){let e=0;const o=t.target.closest("button");if(o){const r=o.closest("li");if(r){const l=r.dataset.id,m=E.find(i=>i._id===l);he(r),m&&(e=1,Se(m,E))}o.querySelector(".icon-pl use").setAttribute("href",`${d}#icon-cart`),o.setAttribute("disabled",!0)}const a=t.target.closest("li");if(a&&!e){const r=a.dataset.id;de(r)}}function he(t){const e=t.dataset.id,s=document.querySelectorAll(".popular-list .item-popular"),o=document.querySelectorAll(".discount-list .discount-item");s.forEach(a=>{if(a.dataset.id===e){const r=a.querySelector(".popularBtn");r.querySelector(".icon-popular use").setAttribute("href",`${d}#icon-cart`),r.setAttribute("disabled",!0)}}),o.forEach(a=>{if(a.dataset.id===e){const r=a.querySelector(".info-div .info-title-link");r.querySelector(".img-svg-osnova use").setAttribute("href",`${d}#icon-cart`),r.setAttribute("disabled",!0)}})}function Se(t,e){const s=Pe(t,e);g.some(a=>a._id===s._id)||(g.push(s),localStorage.setItem(b,JSON.stringify(g)),q())}function Pe(t,e){const s=t._id;return e.find(({_id:o})=>o===s)}const Ee="filter";function Y(){const t=localStorage.getItem(Ee);try{const e=JSON.parse(t),o={...{},...e};return Object.keys(o).forEach(a=>{o[a]===void 0&&delete o[a]}),o}catch(e){return console.error(e),null}}async function $e(){document.getElementById("overlay").style.display="flex";const{keyword:t,category:e,page:s,limit:o,byABC:a,byPrice:r,byPopularity:c}=Y(),l={keyword:t||"",category:e||"",page:s||1,limit:o||6,byABC:a||"",byPrice:r||"",byPopularity:c||""},i=`https://food-boutique.b.goit.study/api/products?${Object.keys(l).filter(n=>l[n]!==void 0&&l[n]!==null&&l[n]!=="").map(n=>`${n}=${l[n]}`).join("&")}`;try{return await S.get(i)}catch(n){console.error(n)}finally{document.getElementById("overlay").style.display="none"}}function Le(){let t;return window.innerWidth<1440&&window.innerWidth>767?t=8:window.innerWidth<768?t=6:t=9,t}function we(){const t=Le(),e=localStorage.getItem("filter"),s=JSON.parse(e);s.limit=Number(t),localStorage.setItem("filter",JSON.stringify(s))}let B=window.innerWidth,x;const M=[768,1440];window.addEventListener("resize",Ie);function Ie(){clearTimeout(x),x=setTimeout(function(){const t=window.innerWidth;ke(B,t)&&(B=t,C.list.innerHTML="",u())},250)}function ke(t,e){return M.some(s=>t<s&&e>=s)||M.some(s=>t>=s&&e<s)}const De="https://food-boutique.b.goit.study/api";function Te(){return S.get(`${De}/products/categories`).then(({data:t})=>t).catch(t=>t)}const p={selector:document.querySelector(".select__body"),currentfilter:document.querySelector(".select__current"),list:document.querySelector(".product-list"),sort:document.querySelector(".sort-body"),currentSort:document.querySelector(".sort-current"),form:document.querySelector("#search")};Te().then(t=>{const e=qe(t);p.selector.insertAdjacentHTML("afterbegin",e),Ae();p.selector.addEventListener("click",Ce);}).catch(t=>{X.Notify.failure(`❌ Oops! Something went wrong! Error ${t} Try reloading the page! ❌`)});function qe(t){return t.map(e=>`<div class="select__item">${e.replace(/_/g," ")}</div>`).join("")}let Ae=function(){let t=document.querySelectorAll(".select__header"),e=document.querySelectorAll(".select__item");t.forEach(a=>{a.addEventListener("click",s)}),e.forEach(a=>{a.addEventListener("click",o)});function s(){this.parentElement.classList.toggle("is-active")}function o(){let a=this.innerText,r=this.closest(".select"),c=r.querySelector(".select__current");c.innerText=a,r.classList.remove("is-active")}};function Ce(t){const e=t.target.innerText.replace(/ /g,"_").replace(/&/g,"%26"),s=localStorage.getItem("filter");if(s)try{const o=JSON.parse(s);t.target.innerText!=="Show all"?o.category=`${e}`:o.category=null,o.page=1,localStorage.setItem("filter",JSON.stringify(o))}catch(o){console.error("Error updating localStorage:",o)}A(1),u()}function Ne(){const{keyword:t,category:e,page:s,limit:o,byABC:a,byPrice:r,byPopularity:c}=Y(),m={keyword:t||null,category:e||null,page:s||1,limit:o||6,byABC:a||"",byPrice:r||"",byPopularity:c||""},i="filter";if(localStorage.getItem("filter")){const n=Q("filter");n.category!==null&&(p.currentfilter.innerText=n.category.replace(/_/g," ").replace(/%26/g,"&")),n.keyword!==null&&(p.form.elements.search.value=n.keyword),n.byABC&&(n.byABC==="false"&&(p.currentSort.innerText="Z to A"),n.byABC==="true"&&(p.currentSort.innerText="A to Z")),n.byPrice&&(n.byPrice==="false"&&(p.currentSort.innerText="Expensive"),n.byPrice==="true"&&(p.currentSort.innerText="Cheap")),n.byPopularity&&(n.byPopularity==="false"&&(p.currentSort.innerText="Popular"),n.byPopularity==="true"&&(p.currentSort.innerText="Not Popular"))}y(i,m)}Ne();let Oe=function(){let t=document.querySelectorAll(".sort-header"),e=document.querySelectorAll(".sort-item");t.forEach(a=>{a.addEventListener("click",s)}),e.forEach(a=>{a.addEventListener("click",o)});function s(){this.parentElement.classList.toggle("is-active")}function o(){let a=this.innerText,r=this.closest(".sort"),c=r.querySelector(".sort-current");c.innerText=a,r.classList.remove("is-active")}};Oe();p.sort.addEventListener("click",_e);function _e(t){const e=t.target.innerText,s=localStorage.getItem("filter");try{const o=JSON.parse(s);e==="A to Z"?(delete o.byPrice,delete o.byPopularity,o.byABC="true",y("filter",o),u()):e==="Z to A"?(delete o.byPrice,delete o.byPopularity,o.byABC="false",y("filter",o),u()):e==="Cheap"?(delete o.byABC,delete o.byPopularity,o.byPrice="true",y("filter",o),u()):e==="Expensive"?(delete o.byABC,delete o.byPopularity,o.byPrice="false",y("filter",o),u()):e==="Popular"?(delete o.byABC,delete o.byPrice,o.byPopularity="false",y("filter",o),u()):e==="Not Popular"?(delete o.byABC,delete o.byPrice,o.byPopularity="true",y("filter",o),u()):e==="Reset All"&&(delete o.byABC,delete o.byPrice,delete o.byPopularity,y("filter",o),u())}catch(o){console.error("Error updating localStorage:",o)}}const O=document.querySelector("#search");let R;O.addEventListener("input",Z);O.addEventListener("submit",Z);function Z(t){t.preventDefault();const e=O.elements.search.value.trim(),s=localStorage.getItem("filter");(t.type==="input"||t.type==="submit")&&(clearTimeout(R),R=setTimeout(()=>{Be(e,s),u(),A(1)},1e3))}function Be(t,e){if(e)try{const s=JSON.parse(e);s.keyword=`${t}`,s.page=1,localStorage.setItem("filter",JSON.stringify(s))}catch(s){console.error("Error updating localStorage:",s)}}async function xe(){document.getElementById("overlay").style.display="flex";const t="https://food-boutique.b.goit.study/api/products/popular";try{return(await S.get(t)).data}catch(e){throw e}finally{document.getElementById("overlay").style.display="none"}}const Me=document.querySelector(".popular-list");let J=[];async function Re(){const t=localStorage.getItem(b),e=5;try{J=(await xe()).slice(0,e);const o=J.map(({img:a,name:r,popularity:c,category:l,size:m,_id:i})=>{const n=t?JSON.parse(t).some(P=>P._id===i):!1,L=n?`${d}#icon-cart`:`${d}#icon-shopping-cart`,w=l.replace(/_/g," ");return`<li class="item-popular" data-id="${i}">
